...
$(function () {
    ...
    request.onOpen = function(response) {
        serverStatus.html($('<p>', { text: 'Atmosphere connected using ' + response.transport }));
    ...
    request.onMessage = function (response) {
        ...
        if (!logged) {
            ...
            var msg = $.emoticons.replace(json.text);
            addMessage(json.author, msg, me ? 'blue' : 'black', new Date());
            input.focus();
        }
    };

    request.onError = function(response) {
        serverStatus.html($('<p>', { text: 'Sorry, but there\'s some problem with your '
